...
# Need manager approval information. 
#If request is over 100 and for accessories, ask for approval
#If request is at or under 100 for accessories, approve and show approved. 
#Need to build the request system for types, block the types off at certain prices, and if it does not meet those guidelines, send user
#a message to request approval from manager. 
#Asset types: tools, software, accessories, 
